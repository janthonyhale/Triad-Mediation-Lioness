DROP TABLE IF EXISTS  `e4447g40733_globals`;SELECT 1;CREATE TABLE `e4447g40733_globals` (
                  ...
                  `value` TEXT NOT NULL
                ) CHARACTER SET utf8;SELECT 1;INSERT INTO `e4447g40733_globals` (`name`, `value`) VALUES ('compiled', '1746767189'),('active', '1'),('testMode', '1'),('totalPlayers', '100000'),('groupSize', '3'),('numberPeriods', '1'),('loopStart', '438340'),('loopEnd', '438341'),('participationFee', '1'),('exchangeRate', '0.01'),('reEnter', '0'),('dropoutHandling', '2'),('sortableMatching', '2'),('message0', '&lt;b&gt;This HIT is currently offline. You cannot participate at this time.&lt;/b&gt;&lt;br&gt;&lt;br&gt;

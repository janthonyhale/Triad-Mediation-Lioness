...
if((true)) {
    ...
    setInterval(function(){
        ...
        // try {
        //     if (parseInt(getValue('core','playerNr='+playerNr,'currentGroupSize')) < 2) {
        //         // other left, show game over screen...
        //         if(!lostconnect){
        //             beep(250, "sine", function () {
        ...
        let to_mediate = getValue('decisions', 'subjectNr=' + 3 + ' and period=' + period, 'mediate');      
    
        /*Now send the message to the other party- so that they can modify their UI accordingly.*/
        // setValue("decisions","groupNr=" + groupNr + " and period=" + period +" and (" + labelname4 + "_chatnotification = 0 or " + labelname4 + "_chatnotification IS NULL) and mediate = " + 1,
        // labelname4 + "_chatnotification","1");
        ...
        if (to_mediate === 1 && (getValuesOthers(labelname4 + "_chatnotification").includes(1) || notify))
        {
            ...
            */
            ...
            else if ((most_recent_msg.includes('Submitted agreement: Buyer gets')) && (most_recent_msg.includes(' refund, seller '))) {
...
$("#submitbutton").click(function() {
    ...
    */
    ...
    let num_msgs = count_substr(all_msgs, "[You]") + count_substr(all_msgs, "[Other]");
